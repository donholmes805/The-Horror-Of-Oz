  ...
  return (
    <aside className="hidden lg:flex flex-col h-screen fixed left-0 top-0 pt-24 pb-8 bg-[#0a0a0a] w-64 border-r border-[#b8860b]/10 shadow-[10px_0_30px_rgba(0,0,0,0.5)] z-40">
      <div className="px-6 mb-8 flex items-center gap-3">
        ...
        <div>
          <p className="font-serif uppercase tracking-widest text-[10px] text-primary">Chronicle Keeper</p>
          <p className="text-[10px] text-muted-foreground">Level 1 | 0 Shards</p>
        </div>
      </div>
